...
TYPED_TEST_SUITE(Fixture_MatN, MyMatTypes_Mat3x3);
...
TYPED_TEST(Fixture_MatN, Associativity)
{
  ...
  Mat C{static_cast<T>(11), static_cast<T>(12), static_cast<T>(13),
        static_cast<T>(14), static_cast<T>(15), static_cast<T>(16),
        static_cast<T>(17), static_cast<T>(18), static_cast<T>(19)};
...
TYPED_TEST(Fixture_MatN, DistributivityLeft)
{
  ...
  Mat P{static_cast<T>(1), static_cast<T>(2), static_cast<T>(3),
        static_cast<T>(4), static_cast<T>(5), static_cast<T>(6),
        static_cast<T>(7), static_cast<T>(8), static_cast<T>(9)};

  Mat Q{static_cast<T>(5),  static_cast<T>(6),  static_cast<T>(7),
        static_cast<T>(8),  static_cast<T>(9),  static_cast<T>(10),
        static_cast<T>(11), static_cast<T>(12), static_cast<T>(13)};

  Mat R{static_cast<T>(11), static_cast<T>(12), static_cast<T>(13),
        static_cast<T>(14), static_cast<T>(15), static_cast<T>(16),
        static_cast<T>(17), static_cast<T>(18), static_cast<T>(19)};
...
typedef ::testing::Types<MatType<5, 2, int>, MatType<5, 2, float>,
                         MatType<5, 2, double>>
  MyMatTypes_5x2;

TYPED_TEST_SUITE(Fixture_MatN52, MyMatTypes_5x2);

TYPED_TEST(Fixture_MatN52, ScalarMultiplication)
{
  using Mat = typename TestFixture::Mat;
  ...
  Mat expected{static_cast<T>(2),  static_cast<T>(4),  static_cast<T>(6),
...
TYPED_TEST(Fixture_MatN52, MatrixAddition)
{
  using Mat = typename TestFixture::Mat;
  using T = typename Mat::value_type;

  // Usando static_cast para asegurar que los valores sean del tipocorrecto
  ...
  Mat B{static_cast<T>(10), static_cast<T>(9), static_cast<T>(8),
        static_cast<T>(7),  static_cast<T>(6), static_cast<T>(5),
        static_cast<T>(4),  static_cast<T>(3), static_cast<T>(2),
        static_cast<T>(1)};
  Mat result = A + B;

  Mat expected{static_cast<T>(11), static_cast<T>(11), static_cast<T>(11),
               static_cast<T>(11), static_cast<T>(11), static_cast<T>(11),
               static_cast<T>(11), static_cast<T>(11), static_cast<T>(11),
               static_cast<T>(11)};
...
TYPED_TEST(Fixture_MatN52, MatrixComparison)
{
  using Mat = typename TestFixture::Mat;
  using T = typename Mat::value_type;
  ...
  Mat C{static_cast<T>(10), static_cast<T>(9), static_cast<T>(8),
        static_cast<T>(7),  static_cast<T>(6), static_cast<T>(5),
        static_cast<T>(4),  static_cast<T>(3), static_cast<T>(2),
        static_cast<T>(1)};
...
TYPED_TEST(Fixture_MatN52, MatrixMultiplication)
{
  using Mat = typename TestFixture::Mat;
  using T = typename Mat::value_type;
  ...
  if constexpr(R == 5 && C == 2)
    {
      ...
      line::structs::SMat<2, 3, T> B{static_cast<T>(11), static_cast<T>(12),
                                     static_cast<T>(13), static_cast<T>(14),
                                     static_cast<T>(15), static_cast<T>(16)};
      auto result = A * B;

      line::structs::SMat<5, 3, T> expected{
